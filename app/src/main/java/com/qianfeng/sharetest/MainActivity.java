...
//        oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
    ...
    public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
        if (hashMap != null) {
            ...
            Log.d("QQ user", builder.toString());
    ...
    public void onError(Platform platform, int i, final Throwable throwable) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity.this, "受权失败" + throwable.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onCancel(Platform platform, int i) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity.this, "受权取消", Toast.LENGTH_SHORT).show();
